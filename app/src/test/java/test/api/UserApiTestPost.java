...
public class UserApiTestPost {
    ...
    public void testCase1_02() {
        ...
        .then()
            ...
            .body("email", equalTo("mregian1@gmail.com"));
    }
    ...
    public void testCase1_03() {
        ...
        .then()
            ...
            .body("lastName", equalTo("Maulana"))
            .body("gender", equalTo("male"))
            .body("email", equalTo("mregian2@gmail.com"));
    }
    ...
    public void testCase1_04() {
        ...
        .then()
            ...
            .body("lastName", equalTo("Maulana"))
            .body("gender", equalTo("male"))
            .body("email", equalTo("mregian3@gmail.com"));
    }
    ...
    public void testCase1_05() {
        ...
        .then()
            ...
            .body("lastName", equalTo("Maulana"))
            .body("gender", equalTo("male"))
            .body("email", equalTo("mregian4@gmail.com"));
    }
    ...
    public void testCase1_06() {
        ...
        .then()
            ...
            .body("lastName", equalTo("Maulana"))
            .body("gender", equalTo("male"))
            .body("email", equalTo("mregian5@gmail.com"));
    }
}